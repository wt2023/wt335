    ...
    switch (dummySpell->SpellFamilyName)
    {
        case SPELLFAMILY_GENERIC:
        {
            switch (dummySpell->Id)
            {
                ...
                case 82000:                                  //1%吸血   这个数字就是我spell.dbc里新添加的技能，可以根据自己的技能表更改。
                {
                    triggered_spell_id = 52724;      //52724  这个是调用spell.dbc里的吸血鬼之触，这个技能是伤害的100%转换气血，代码不要改。
                    basepoints0 = damage / 100;              //  damage / 100的意思是伤害的百分之1转换为气血，举例： damage / 10 就是百分之10转换气血。
                    target = this;
                    break;
                }
                case 82001:                                  //2%吸血   这个数字就是我spell.dbc里新添加的技能，可以根据自己的技能表更改。
                {
                    triggered_spell_id = 52724;      //52724  这个是调用spell.dbc里的吸血鬼之触，这个技能是伤害的100%转换气血，代码不要改。
                    basepoints0 = damage / 50;              //  damage / 100的意思是伤害的百分之1转换为气血，举例： damage / 10 就是百分之10转换气血。
                    target = this;
                    break;
                }
                case 82002:                                  //4%吸血   这个数字就是我spell.dbc里新添加的技能，可以根据自己的技能表更改。
                {
                    triggered_spell_id = 52724;      //52724  这个是调用spell.dbc里的吸血鬼之触，这个技能是伤害的100%转换气血，代码不要改。
                    basepoints0 = damage / 25;              //  damage / 100的意思是伤害的百分之1转换为气血，举例： damage / 10 就是百分之10转换气血。
                    target = this;
                    break;
                }
                case 82003:                                  //5%吸血   这个数字就是我spell.dbc里新添加的技能，可以根据自己的技能表更改。
                {
                    triggered_spell_id = 52724;      //52724  这个是调用spell.dbc里的吸血鬼之触，这个技能是伤害的100%转换气血，代码不要改。
                    basepoints0 = damage / 20;              //  damage / 100的意思是伤害的百分之1转换为气血，举例： damage / 10 就是百分之10转换气血。
                    target = this;
                    break;
                }
                case 82004:                                  //10%吸血   这个数字就是我spell.dbc里新添加的技能，可以根据自己的技能表更改。
                {
                    triggered_spell_id = 52724;      //52724  这个是调用spell.dbc里的吸血鬼之触，这个技能是伤害的100%转换气血，代码不要改。
                    basepoints0 = damage / 10;              //  damage / 100的意思是伤害的百分之1转换为气血，举例： damage / 10 就是百分之10转换气血。
                    target = this;
                    break;
                }
                case 82005:                                  //20%吸血   这个数字就是我spell.dbc里新添加的技能，可以根据自己的技能表更改。
                {
                    triggered_spell_id = 52724;      //52724  这个是调用spell.dbc里的吸血鬼之触，这个技能是伤害的100%转换气血，代码不要改。
                    basepoints0 = damage / 5;              //  damage / 100的意思是伤害的百分之1转换为气血，举例： damage / 10 就是百分之10转换气血。
                    target = this;
                    break;
                }
                case 82006:                                  //25%吸血   这个数字就是我spell.dbc里新添加的技能，可以根据自己的技能表更改。
                {
                    triggered_spell_id = 52724;      //52724  这个是调用spell.dbc里的吸血鬼之触，这个技能是伤害的100%转换气血，代码不要改。
                    basepoints0 = damage / 4;              //  damage / 100的意思是伤害的百分之1转换为气血，举例： damage / 10 就是百分之10转换气血。
                    target = this;
                    break;
                }
                case 82007:                                  //50%吸血   这个数字就是我spell.dbc里新添加的技能，可以根据自己的技能表更改。
                {
                    triggered_spell_id = 52724;      //52724  这个是调用spell.dbc里的吸血鬼之触，这个技能是伤害的100%转换气血，代码不要改。
                    basepoints0 = damage / 2;              //  damage / 100的意思是伤害的百分之1转换为气血，举例： damage / 10 就是百分之10转换气血。
                    target = this;
                    break;
                }
                case 82008:                                  //100%吸血   这个数字就是我spell.dbc里新添加的技能，可以根据自己的技能表更改。
                {
                    triggered_spell_id = 52724;      //52724  这个是调用spell.dbc里的吸血鬼之触，这个技能是伤害的100%转换气血，代码不要改。
                    basepoints0 = damage / 1;              //  damage / 100的意思是伤害的百分之1转换为气血，举例： damage / 10 就是百分之10转换气血。
                    target = this;
                    break;
                }
