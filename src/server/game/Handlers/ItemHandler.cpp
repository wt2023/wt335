...
void WorldSession::HandleAutoEquipItemSlotOpcode(WorldPacket & recvData)
{
    ...
    {
        ChatHandler(_player->GetSession()).PSendSysMessage("这个地图无法切换装备.");
        return;
    }
...
void WorldSession::HandleBuyItemInSlotOpcode(WorldPacket & recvData)
{
    ...
    if (sReq->IsExist(reqId))
    {
        ...
        sCF->SendAcceptOrCancel(GetPlayer(), 1000000, sReq->Notice(GetPlayer(), reqId, "购买", sCF->GetItemLink(item), count), true);
    }
    else
